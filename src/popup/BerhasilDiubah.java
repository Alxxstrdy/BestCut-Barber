 ...
 * @author Alxxstrdy
 */
public class BerhasilDiubah extends javax.swing.JDialog {

    /**
     * Creates new form Berhasil
     */
    public BerhasilDiubah(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Password berhasil diubah");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BerhasilDiubah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BerhasilDiubah dialog = new BerhasilDiubah(new javax.swing.JFrame(), true);
