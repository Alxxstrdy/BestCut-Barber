 ...
 * @author Alxxstrdy
 */
public class BerhasilUpdate extends javax.swing.JDialog {

    /**
     * Creates new form Berhasil
     */
    public BerhasilUpdate(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Data Berhasil Diperbarui");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BerhasilUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BerhasilUpdate dialog = new BerhasilUpdate(new javax.swing.JFrame(), true);
