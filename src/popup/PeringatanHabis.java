 ...
 * @author Alxxstrdy
 */
public class PeringatanHabis extends javax.swing.JDialog {

    /**
     * Creates new form Peringatan
     */
    public PeringatanHabis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Stok Barang Tidak cukup/Habis");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PeringatanHabis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PeringatanHabis dialog = new PeringatanHabis(new javax.swing.JFrame(), true);
