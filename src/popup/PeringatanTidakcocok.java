 ...
 * @author Alxxstrdy
 */
public class PeringatanTidakcocok extends javax.swing.JDialog {

    /**
     * Creates new form Peringatan
     */
    public PeringatanTidakcocok(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Konfirmasi password tidak sesuai");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PeringatanTidakcocok.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PeringatanTidakcocok dialog = new PeringatanTidakcocok(new javax.swing.JFrame(), true);
