 ...
 * @author Alxxstrdy
 */
public class PeringatanPassLama extends javax.swing.JDialog {

    /**
     * Creates new form Peringatan
     */
    public PeringatanPassLama(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Password lama tidak sesuai");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PeringatanPassLama.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PeringatanPassLama dialog = new PeringatanPassLama(new javax.swing.JFrame(), true);
