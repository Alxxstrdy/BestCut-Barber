 ...
 * @author Alxxstrdy
 */
public class PeringatanKurang extends javax.swing.JDialog {

    /**
     * Creates new form Peringatan
     */
    public PeringatanKurang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Uang Customer Kurang");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PeringatanKurang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PeringatanKurang dialog = new PeringatanKurang(new javax.swing.JFrame(), true);
