 ...
 * @author Alxxstrdy
 */
public class PeringatanLebih extends javax.swing.JDialog {

    /**
     * Creates new form Peringatan
     */
    public PeringatanLebih(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Nama tidak boleh lebih dari 20");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PeringatanLebih.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PeringatanLebih dialog = new PeringatanLebih(new javax.swing.JFrame(), true);
