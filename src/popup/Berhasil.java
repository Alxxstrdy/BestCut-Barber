 ...
 * @author Alxxstrdy
 */
public class Berhasil extends javax.swing.JDialog {

    /**
     * Creates new form Berhasil
     */
    public Berhasil(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Data Berhasil Ditambahkan");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Berhasil dialog = new Berhasil(new javax.swing.JFrame(), true);
