 ...
 * @author Alxxstrdy
 */
public class PeringatanKosong extends javax.swing.JDialog {

    /**
     * Creates new form Peringatan
     */
    public PeringatanKosong(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Data tidak boleh kosong");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PeringatanKosong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PeringatanKosong dialog = new PeringatanKosong(new javax.swing.JFrame(), true);
