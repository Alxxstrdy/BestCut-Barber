 ...
 * @author Alxxstrdy
 */
public class SelesaiReservasi extends javax.swing.JDialog {

    /**
     * Creates new form Berhasil
     */
    public SelesaiReservasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelesaiReservasi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SelesaiReservasi dialog = new SelesaiReservasi(new javax.swing.JFrame(), true);
