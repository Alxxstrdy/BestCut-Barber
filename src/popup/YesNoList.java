 ...
 * @author Alxxstrdy
 */
public class YesNoList extends javax.swing.JDialog {

    private PriceList pricelist;
    
    public YesNoList(java.awt.Frame parent, boolean modal, PriceList priceList) {
        super(parent, modal);
        initComponents();
        this.pricelist = priceList;
    }

    private YesNoList(JFrame jFrame, boolean b) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(YesNoList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                YesNoList dialog = new YesNoList(new javax.swing.JFrame(), true);       
