 ...
 * @author Alxxstrdy
 */
public class BerhasilHapus extends javax.swing.JDialog {

    /**
     * Creates new form Berhasil
     */
    public BerhasilHapus(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BerhasilHapus dialog = new BerhasilHapus(new javax.swing.JFrame(), true);
